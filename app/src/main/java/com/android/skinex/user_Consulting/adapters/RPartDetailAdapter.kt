...
class RPartDetailAdapter(fb: String, category : String, var context : Context) : RecyclerView.Adapter<RPartDetailAdapter.RPartDetailViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RPartDetailViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.body_part_detail, parent, false)
        return RPartDetailViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: RPartDetailViewHolder, position: Int)  {
    ...
    fun selectArr(fb : String, part : String) {
        when (fb) {
            ...
            "front" -> {
                ...
                (context as ReturningInfoActivity).findViewById<ImageView>(R.id.bodyImage)
    ...
    inner class RPartDetailViewHolder(view: View): RecyclerView.ViewHolder(view) {
