...
//
//    fun getMsg() {
//        binding.getnamemsg2.setText(Visiter.Visi.name)
//        binding.getbirthmsg2.setText(Visiter.Visi.birth)
//        binding.getgendermsg2.setText(Visiter.Visi.gender)
//    }
//
//
//    // 액티비티 시작 설정
...
//                    Toast.makeText(this@CameraDetailActivity, "Saved $file", Toast.LENGTH_LONG).show()
//                    createCameraPreview()
//                    var intent = Intent()
...
//    //촬영 클릭시 전체촬영 이벤트
//    fun goResultInfo(){
//        binding.goResultInfo.setOnClickListener {
////            var NAME = intent.getStringExtra("NAME")
////            Intent(this, ResultInfoActivity::class.java).putExtra("NAME", NAME)
